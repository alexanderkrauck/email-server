...
from src.handlers.email_handler import router as email_router, email_processor
...
app = FastAPI(
    ...
    description="Multi-SMTP Email Server with File Logging",
    version="1.0.0",
    lifespan=lifespan
)
...
final_app = FastAPI(
    ...
    description="Multi-SMTP Email Server with both HTTP API and MCP support",
    version="1.0.0",
